...
class Nhom(models.Model):
    ...
    mon_hoc_id = models.ForeignKey('MonHoc', verbose_name='Tên Môn Học')
...
class ThanhVienNhom(models.Model):
    user_id = models.ForeignKey(User, verbose_name='Tên thành viên')
    nhom_id = models.ForeignKey('Nhom', verbose_name='Nhóm tham gia')
    ngay_tham_gia = models.DateField(auto_now_add=True)
    acitve = models.BooleanField(default=False)
    nhom_truong = models.BooleanField(default=False)
